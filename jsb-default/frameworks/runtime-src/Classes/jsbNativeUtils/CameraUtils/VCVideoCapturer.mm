...
{
    // 根据连接取得设备输出的数据
    [self.captureStillImageOutput captureStillImageAsynchronouslyFromConnection:self.captureConnection
...
//            NSLog(@"获取到的人脸特征数据为：%@", detectFaceRequest.results);
//
//
